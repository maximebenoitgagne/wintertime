...
CCOG]]]
      ...
      _RL PAR_ice0(1-OLx:sNx+OLx,1-OLy:sNy+OLy,nSx,nSy)
      _RL PAR_ice1(1-OLx:sNx+OLx,1-OLy:sNy+OLy,nSx,nSy)
      _RL surfPAR_ice(1-OLx:sNx+OLx,1-OLy:sNy+OLy,nSx,nSy)
...
C PAR_ice forcing parameters for exf

      _RL PAR_iceStartTime

      COMMON/gud_forcing_PAR_ice_c/
     &    PAR_icemask, PAR_icefile
      COMMON/gud_forcing_PAR_ice_i/
     &    PAR_icestartdate1, PAR_icestartdate2
      COMMON/gud_forcing_PAR_ice_r/
     &    PAR_iceStartTime,
     &    PAR_iceperiod, PAR_iceconst,
     &    PAR_ice_exfremo_intercept, PAR_ice_exfremo_slope,
     &    gud_inscal_PAR_ice
      CHARACTER*128  PAR_icefile
      CHARACTER*1 PAR_icemask
      INTEGER PAR_icestartdate1
      INTEGER PAR_icestartdate2
      _RL PAR_iceperiod
      _RL PAR_iceconst
      _RL PAR_ice_exfremo_intercept
      _RL PAR_ice_exfremo_slope
      _RL gud_inscal_PAR_ice

#ifdef USE_EXF_INTERPOLATION
      COMMON/gud_interp_PAR_ice_i/
     &    PAR_ice_nlon, PAR_ice_nlat, PAR_ice_interpMethod
      COMMON/gud_interp_PAR_ice_r/
     &    PAR_ice_lon0, PAR_ice_lat0, PAR_ice_lon_inc, PAR_ice_lat_inc
      INTEGER PAR_ice_interpMethod, PAR_ice_nlon, PAR_ice_nlat
      _RL  PAR_ice_lon0
      _RL  PAR_ice_lat0
      _RL  PAR_ice_lon_inc
      _RL  PAR_ice_lat_inc(MAX_LAT_INC)
#endif
